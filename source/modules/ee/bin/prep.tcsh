...
#   Usage:        prompt% source bin/prep.tcsh
#

setenv ASREPO $cwd/aerospike-server
setenv CLIENTREPO $cwd/aerospike-client-c
setenv EEREPO $cwd/aerospike-server-enterprise
